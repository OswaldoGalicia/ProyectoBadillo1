...
?>
    <section class="w-5/10 mt-10 m-auto border-2 border-gray-400 rounded-lg p-5">
        <h1 class="text-gray-600 text-xl text-center">Registro de Usuario</h1>
        <?php foreach($errores as $error){ ?> 
            <p class="border border-red-600 bg-red-200 text-red-600 text-center py-2 w-full m-2"><?php echo $error ?></p>
        <?php } ?>
        <div class="m-4">
            <form action="session/registerUser.php" method="POST">
                ...
                <fieldset class="m-2 p-0 border border-blue-500 rounded-full px-2">
                    ...
                    <input class="w-full" name="email" type="email" placeholder="Correo Electronico..." required>
                </fieldset>
                <fieldset class="m-2 p-0 border border-blue-500 rounded-full px-2">
                ...
                <fieldset class="m-2 p-0 border border-blue-500 rounded-full px-2">
                    ...
                    <input class="w-full" name="repPwd" type="password" placeholder="Repetir contreña..." required>
                </fieldset>
                <button type="submit" class="bg-blue-800 text-white font-bold py-2 rounded-full w-full hover:bg-yellow-500 duration-100 ease-in ">Registrarse</button>
            </form>
        </div>
    </section>
</body>
